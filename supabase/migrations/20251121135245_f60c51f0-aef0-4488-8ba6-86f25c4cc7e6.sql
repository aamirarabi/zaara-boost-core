...
DROP POLICY IF EXISTS "Admin full access to chat_history" ON public.chat_history;
...
DROP POLICY IF EXISTS "Admin full access to conversation_context" ON public.conversation_context;
